---
description: Guidelines for writing clean, maintainable, and idiomatic C# code with a focus on functional patterns and proper abstraction. Adapted from Aaronontheweb/dotnet-cursor-rules (MIT).
globs: *.cs
paths:
  - "**/*.cs"
alwaysApply: false
