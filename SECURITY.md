...
to a remote ref, writes outside session worktree boundary, writes into `.git` or build output. It is deliberately narrow, it is not a security boundary, and it
